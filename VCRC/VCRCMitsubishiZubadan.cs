...
public class VCRCMitsubishiZubadan : AbstractTwoStageVCRC, IEntropyAnalysable
{
    ...
    /// </exception>
    /// <exception cref="ValidationException">
    ///     There should be a two-phase refrigerant
        ...
        : base(evaporator, compressor, condenser)
    {
        ...
        Point5 = Point4.CompressionTo(
            Condenser.Pressure,
            Compressor.Efficiency
        );
        Recuperator = new Recuperator(
            Point7!.Temperature - Point2!.Temperature
        );
    }
    ...
    public sealed override Ratio HeatReleaserSpecificMassFlow =>
        ...
        * (
            1
            + (Point8.Enthalpy - Point11.Enthalpy)
    ...
    private void CalculateInjectionQuality()
    {
        ...
        do
        {
            ...
            Point11 = Point8.CoolingTo(
                Point9.Temperature + Economizer.TemperatureDifference
            );
