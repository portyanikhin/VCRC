        ...
        IClassFixture<TranscriticalVCRCFixture<VCRCWithEconomizerAndPC>>
{
    ...
    public VCRCWithEconomizerAndPCTranscriticalTests(
        ...
        TranscriticalVCRCFixture<VCRCWithEconomizerAndPC> vcrc
    )
    {
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.EER
            .Should()
            .BeApproximately(3.0102645369221146, _comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.COP
            .Should()
            .BeApproximately(4.010264536922114, _comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout17() =>
        _vcrc.AnalysisResult.ThermodynamicPerfection.Percent
            .Should()
            .BeApproximately(17.576677701417122, _comparison.Tolerance);

    [Fact]
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout17() =>
        _vcrc.AnalysisResult.MinSpecificWorkRatio.Percent
            .Should()
            .BeApproximately(17.528787484286372, _comparison.Tolerance);
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        _vcrc.AnalysisResult.GasCoolerEnergyLossRatio.Percent
            .Should()
            .BeApproximately(22.05038848497776, _comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        _vcrc.AnalysisResult.ExpansionValvesEnergyLossRatio.Percent
            .Should()
            .BeApproximately(22.42167893512621, _comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout14() =>
        _vcrc.AnalysisResult.EvaporatorEnergyLossRatio.Percent
            .Should()
            .BeApproximately(14.46098633383068, _comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        _vcrc.AnalysisResult.AnalysisRelativeError.Percent
            .Should()
            .BeApproximately(0.27320895511843885, _comparison.Tolerance);
