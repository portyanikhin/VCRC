    ...
    IClassFixture<TranscriticalVCRCFixture<VCRCWithEconomizerAndPC>>
{
    public VCRCWithEconomizerAndPCTranscriticalTests(
        TranscriticalVCRCFixture<VCRCWithEconomizerAndPC> fixture) => Fixture = fixture;

    private TranscriticalVCRCFixture<VCRCWithEconomizerAndPC> Fixture { get; }
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        Fixture.Cycle.EER.Should().BeApproximately(3.0102645369221146, Fixture.Tolerance);
    }
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        Fixture.AnalysisResult.GasCoolerEnergyLossRatio.Percent
            .Should().BeApproximately(22.05038848497776, Fixture.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        Fixture.AnalysisResult.ExpansionValvesEnergyLossRatio.Percent
            .Should().BeApproximately(22.42167893512621, Fixture.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout14() =>
        Fixture.AnalysisResult.EvaporatorEnergyLossRatio.Percent
            .Should().BeApproximately(14.46098633383068, Fixture.Tolerance);
