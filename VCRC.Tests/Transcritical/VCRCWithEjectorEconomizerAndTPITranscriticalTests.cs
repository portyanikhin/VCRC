        ...
        IClassFixture<TranscriticalVCRCFixture<VCRCWithEjectorEconomizerAndTPI>>
{
    ...
    public VCRCWithEjectorEconomizerAndTPITranscriticalTests(
        ...
        TranscriticalVCRCFixture<VCRCWithEjectorEconomizerAndTPI> vcrc
    )
    {
    ...
    {
        _vcrc.Instance.Point1.Pressure.Pascals
            .Should()
            .BeApproximately(
        ...
        _vcrc.Instance.Point1
            .Should()
            .Be(_vcrc.Refrigerant.DewPointAt(_vcrc.Instance.Point1.Pressure));
    ...
    {
        _vcrc.Instance.Point7.Pressure
            .Equals(
                _vcrc.Instance.IntermediatePressure,
    ...
    public void IntermediatePressure_ForThisCase_ReturnsMiddlePressureBetweenDiffuserOutletAndGasCoolerPressures() =>
        _vcrc.Instance.IntermediatePressure.Pascals
            ...
            .BeApproximately(
                Math.Sqrt(
                    _vcrc.EjectorFlows.DiffuserOutlet.Pressure.Pascals
                        * _vcrc.GasCooler.Pressure.Pascals
                ),
                50
            );
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.EER
            .Should()
            .BeApproximately(3.1856966924103642, _comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.COP
            .Should()
            .BeApproximately(4.1856342597396194, _comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout18() =>
        _vcrc.AnalysisResult.ThermodynamicPerfection.Percent
            .Should()
            .BeApproximately(18.60101108396916, _comparison.Tolerance);

    [Fact]
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout18() =>
        _vcrc.AnalysisResult.MinSpecificWorkRatio.Percent
            .Should()
            .BeApproximately(18.573237119700696, _comparison.Tolerance);
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout13() =>
        _vcrc.AnalysisResult.GasCoolerEnergyLossRatio.Percent
            .Should()
            .BeApproximately(13.752593268728353, _comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        _vcrc.AnalysisResult.AnalysisRelativeError.Percent
            .Should()
            .BeApproximately(0.1495375528210737, _comparison.Tolerance);
