    ...
    IClassFixture<TranscriticalVCRCFixture<VCRCWithEjectorAndEconomizer>>
{
    public VCRCWithEjectorAndEconomizerTranscriticalTests(
        TranscriticalVCRCFixture<VCRCWithEjectorAndEconomizer> fixture) => Fixture = fixture;

    private TranscriticalVCRCFixture<VCRCWithEjectorAndEconomizer> Fixture { get; }
    ...
    public void Point7_Always_ReturnsEconomizerColdOutlet()
    {
        ...
        Fixture.Cycle.Point7.Phase.Should().Be(Phases.SupercriticalGas);
    }
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        Fixture.Cycle.EER.Should().BeApproximately(3.5076990300399533, Fixture.Tolerance);
    }
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout21() =>
        Fixture.AnalysisResult.GasCoolerEnergyLossRatio.Percent
            .Should().BeApproximately(21.62366337364647, Fixture.Tolerance);
