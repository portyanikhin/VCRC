    ...
    IClassFixture<TranscriticalVCRCFixture<VCRCWithIIC>>
{
    public VCRCWithIICTranscriticalTests(
        TranscriticalVCRCFixture<VCRCWithIIC> fixture) => Fixture = fixture;

    private TranscriticalVCRCFixture<VCRCWithIIC> Fixture { get; }
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        Fixture.Cycle.EER.Should().BeApproximately(2.935653303601381, Fixture.Tolerance);
    }
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout21() =>
        Fixture.AnalysisResult.GasCoolerEnergyLossRatio.Percent
            .Should().BeApproximately(21.022190486946972, Fixture.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout26() =>
        Fixture.AnalysisResult.ExpansionValvesEnergyLossRatio.Percent
            .Should().BeApproximately(26.061305006201664, Fixture.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout14() =>
        Fixture.AnalysisResult.EvaporatorEnergyLossRatio.Percent
            .Should().BeApproximately(14.071452712259557, Fixture.Tolerance);
    ...
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        Fixture.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(1.7816362060747746, Fixture.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        Fixture.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.4548531874847325, Fixture.Tolerance);
