        ...
        IClassFixture<SubcriticalVCRCFixture<VCRCMitsubishiZubadan>>
{
    ...
    public VCRCMitsubishiZubadanTests(
        ...
        SubcriticalVCRCFixture<VCRCMitsubishiZubadan> vcrc
    )
    {
    ...
    public void Recuperator_Always_CreatesAutomaticallyByTemperatureDifference() =>
        _vcrc.Instance.Recuperator
            .Should()
            .Be(
                new Recuperator(
                    _vcrc.Instance.Point7.Temperature
                        - _vcrc.Instance.Point2.Temperature
                )
            );
    ...
    {
        _vcrc.Instance.RecuperatorHighPressure
            .Equals(
                Math.Sqrt(
    ...
    {
        _vcrc.Instance.Point5s
            .Should()
            .Be(
                _vcrc.Instance.Point4.IsentropicCompressionTo(
    ...
    public void Point7_Always_ReturnsRecuperatorHotInlet()
    {
        ...
        _vcrc.Instance.RecuperatorHighPressure
            .Should()
            .BeGreaterThan(_vcrc.Instance.IntermediatePressure);
        _vcrc.Instance.RecuperatorHighPressure
            .Should()
            .BeLessThan(_vcrc.Condenser.Pressure);
    ...
    {
        _vcrc.Instance.Point10.Pressure
            .Equals(
                _vcrc.Instance.IntermediatePressure,
                _comparison.Tolerance.Pascals()
            )
            .Should()
            .BeTrue();
        _vcrc.Instance.Point10.Enthalpy
            .Equals(
    ...
    {
        _vcrc.Instance.Point11
            .Should()
            .Be(
                _vcrc.Instance.Point8.CoolingTo(
                    _vcrc.Instance.Point9.Temperature
    ...
    public void Point12_Always_ReturnsEvaporatorInlet()
    {
        _vcrc.Instance.Point12
            .Should()
            .Be(
                _vcrc.Instance.Point11.IsenthalpicExpansionTo(
            ...
            .Equals(
                _vcrc.Instance.Point3s.Enthalpy
                    ...
                    + _vcrc
                        ...
                        .DecimalFractions
                        * (
                            _vcrc.Instance.Point5s.Enthalpy
                            - _vcrc.Instance.Point4.Enthalpy
                        ),
    ...
    public void SpecificCoolingCapacity_Always_ReturnsEnthalpyDifferenceInEvaporator() =>
        _vcrc.Instance.SpecificCoolingCapacity
            .Equals(
                _vcrc.Instance.Point1.Enthalpy
                    - _vcrc.Instance.Point12.Enthalpy,
                _comparison.Tolerance.JoulesPerKilogram()
            )
            .Should()
            .BeTrue();
