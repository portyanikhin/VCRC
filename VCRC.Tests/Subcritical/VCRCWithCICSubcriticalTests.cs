    ...
    IClassFixture<SubcriticalVCRCFixture<VCRCWithCIC>>
{
    public VCRCWithCICSubcriticalTests(
        SubcriticalVCRCFixture<VCRCWithCIC> fixture) => Fixture = fixture;

    private SubcriticalVCRCFixture<VCRCWithCIC> Fixture { get; }
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        Fixture.Cycle.EER.Should().BeApproximately(4.70997760850132, Fixture.Tolerance);
    }
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout18() =>
        Fixture.AnalysisResult.CondenserEnergyLossRatio.Percent
            .Should().BeApproximately(18.60109394740889, Fixture.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout8() =>
        Fixture.AnalysisResult.ExpansionValvesEnergyLossRatio.Percent
            .Should().BeApproximately(8.471128033792134, Fixture.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        Fixture.AnalysisResult.EvaporatorEnergyLossRatio.Percent
            .Should().BeApproximately(22.931745882518022, Fixture.Tolerance);
    ...
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout2() =>
        Fixture.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(2.6283463042296296, Fixture.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        Fixture.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.4876971425224632, Fixture.Tolerance);
