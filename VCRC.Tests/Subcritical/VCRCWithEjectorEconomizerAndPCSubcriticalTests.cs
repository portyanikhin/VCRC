    ...
    IClassFixture<SubcriticalVCRCFixture<VCRCWithEjectorEconomizerAndPC>>
{
    public VCRCWithEjectorEconomizerAndPCSubcriticalTests(
        SubcriticalVCRCFixture<VCRCWithEjectorEconomizerAndPC> fixture) => Fixture = fixture;

    private SubcriticalVCRCFixture<VCRCWithEjectorEconomizerAndPC> Fixture { get; }
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        Fixture.Cycle.EER.Should().BeApproximately(4.845602639140372, Fixture.Tolerance);
    }
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout21() =>
        Fixture.AnalysisResult.CondenserEnergyLossRatio.Percent
            .Should().BeApproximately(21.115461229691114, Fixture.Tolerance);
    ...
    public void EconomizerEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        Fixture.AnalysisResult.EconomizerEnergyLossRatio.Percent
            .Should().BeApproximately(1.7980370178155778, Fixture.Tolerance);

    [Fact]
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout0() =>
        Fixture.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(0.055584683784087395, Fixture.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        Fixture.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.023527093808216284, Fixture.Tolerance);
