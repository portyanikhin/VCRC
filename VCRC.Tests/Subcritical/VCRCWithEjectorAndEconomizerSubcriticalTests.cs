    ...
    IClassFixture<SubcriticalVCRCFixture<VCRCWithEjectorAndEconomizer>>
{
    ...
    private readonly SubcriticalVCRCFixture<VCRCWithEjectorAndEconomizer> _vcrc;

    public VCRCWithEjectorAndEconomizerSubcriticalTests(
        ComparisonFixture comparison, SubcriticalVCRCFixture<VCRCWithEjectorAndEconomizer> vcrc)
    {
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.EER.Should().BeApproximately(4.783695679338165, _comparison.Tolerance);
    }
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout21() =>
        _vcrc.AnalysisResult.CondenserEnergyLossRatio.Percent
            .Should().BeApproximately(21.946588574688754, _comparison.Tolerance);
    ...
    public void EconomizerEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        _vcrc.AnalysisResult.EconomizerEnergyLossRatio.Percent
            .Should().BeApproximately(1.7725334295847335, _comparison.Tolerance);

    [Fact]
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout0() =>
        _vcrc.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(0.05889478707478723, _comparison.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        _vcrc.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.166409223662599, _comparison.Tolerance);
