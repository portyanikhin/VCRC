    ...
    IClassFixture<SubcriticalVCRCFixture<VCRCWithEconomizerAndPC>>
{
    ...
    private readonly SubcriticalVCRCFixture<VCRCWithEconomizerAndPC> _vcrc;

    public VCRCWithEconomizerAndPCSubcriticalTests(
        ComparisonFixture comparison, SubcriticalVCRCFixture<VCRCWithEconomizerAndPC> vcrc)
    {
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.EER.Should().BeApproximately(4.571161584395723, _comparison.Tolerance);
    }
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        _vcrc.AnalysisResult.CondenserEnergyLossRatio.Percent
            .Should().BeApproximately(22.02518203021821, _comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout7() =>
        _vcrc.AnalysisResult.ExpansionValvesEnergyLossRatio.Percent
            .Should().BeApproximately(7.009215475275353, _comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        _vcrc.AnalysisResult.EvaporatorEnergyLossRatio.Percent
            .Should().BeApproximately(22.340527798473286, _comparison.Tolerance);
    ...
    public void EconomizerEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        _vcrc.AnalysisResult.EconomizerEnergyLossRatio.Percent
            .Should().BeApproximately(1.7894781048364086, _comparison.Tolerance);

    [Fact]
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout0() =>
        _vcrc.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(0.16357797122982776, _comparison.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        _vcrc.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.06974994089376046, _comparison.Tolerance);
