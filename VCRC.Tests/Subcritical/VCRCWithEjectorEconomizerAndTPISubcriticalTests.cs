    ...
    IClassFixture<SubcriticalVCRCFixture<VCRCWithEjectorEconomizerAndTPI>>
{
    ...
    private readonly SubcriticalVCRCFixture<VCRCWithEjectorEconomizerAndTPI> _vcrc;

    public VCRCWithEjectorEconomizerAndTPISubcriticalTests(
        ComparisonFixture comparison, SubcriticalVCRCFixture<VCRCWithEjectorEconomizerAndTPI> vcrc)
    {
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        _vcrc.Instance.EER.Should().BeApproximately(4.877124735439032, _comparison.Tolerance);
    }
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout19() =>
        _vcrc.AnalysisResult.CondenserEnergyLossRatio.Percent
            .Should().BeApproximately(19.138658083587742, _comparison.Tolerance);
    ...
    public void EconomizerEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        _vcrc.AnalysisResult.EconomizerEnergyLossRatio.Percent
            .Should().BeApproximately(1.819717819138191, _comparison.Tolerance);

    [Fact]
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        _vcrc.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(1.274333280596639, _comparison.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        _vcrc.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.17116247380301927, _comparison.Tolerance);
