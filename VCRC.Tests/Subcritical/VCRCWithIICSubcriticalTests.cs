    ...
    IClassFixture<SubcriticalVCRCFixture<VCRCWithIIC>>
{
    public VCRCWithIICSubcriticalTests(
        SubcriticalVCRCFixture<VCRCWithIIC> fixture) => Fixture = fixture;

    private SubcriticalVCRCFixture<VCRCWithIIC> Fixture { get; }
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        Fixture.Cycle.EER.Should().BeApproximately(4.591346929801504, Fixture.Tolerance);
    }
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        Fixture.AnalysisResult.CondenserEnergyLossRatio.Percent
            .Should().BeApproximately(22.953213501021036, Fixture.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout7() =>
        Fixture.AnalysisResult.ExpansionValvesEnergyLossRatio.Percent
            .Should().BeApproximately(7.656335268000471, Fixture.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        Fixture.AnalysisResult.EvaporatorEnergyLossRatio.Percent
            .Should().BeApproximately(22.3568946179561, Fixture.Tolerance);
    ...
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout0() =>
        Fixture.AnalysisResult.MixingEnergyLossRatio.Percent
            .Should().BeApproximately(0.3519218513643524, Fixture.Tolerance);

    [Fact]
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        Fixture.AnalysisResult.AnalysisRelativeError.Percent
            .Should().BeApproximately(0.47541346565012926, Fixture.Tolerance);
