...
public class CondenserTests : IClassFixture<ComparisonFixture>
{
    ...
    {
        _condenser.Temperature.Equals(Temperature, _comparison.Tolerance.DegreesCelsius())
            .Should().BeTrue();
    ...
    {
        _condenser.Subcooling.Equals(Subcooling, TemperatureDelta.FromKelvins(_comparison.Tolerance))
            .Should().BeTrue();
    ...
    {
        _condenser.Pressure.Equals(_condenser.Outlet.Pressure, _comparison.Tolerance.Pascals())
            .Should().BeTrue();
