        ...
        IClassFixture<TranscriticalVCRCFixture<IVCRCWithEconomizerAndTPI>>
{
    ...
    private readonly TranscriticalVCRCFixture<IVCRCWithEconomizerAndTPI> _fixture;
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        _fixture
            ...
            .EER
            .Should()
            .BeApproximately(2.7733154591838005, _comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        _fixture
            ...
            .COP
            .Should()
            .BeApproximately(3.773315459183803, _comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout16() =>
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(16.193152260389702, _comparison.Tolerance);
    ...
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout16() =>
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(16.124874623066734, _comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout30() =>
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(30.34923839135392, _comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout13() =>
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(13.302779314766417, _comparison.Tolerance);
    ...
    public void EconomizerEnergyLossRatio_ForThisCase_ReturnsAbout2() =>
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(2.533522866403796, _comparison.Tolerance);
    ...
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout3() =>
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(3.8483060252931014, _comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        _fixture
            ...
            .Percent
            .Should()
            .BeApproximately(0.4234305005094076, _comparison.Tolerance);
        _fixture
            .AnalysisResult
            .Sum()
            .Percent
