...
public sealed class VCRCWithEconomizerAndTPITranscriticalTests(
    ...
    TranscriticalVCRCFixture<IVCRCWithEconomizerAndTPI> fixture
)
    : IClassFixture<ComparisonFixture>,
        IClassFixture<TranscriticalVCRCFixture<IVCRCWithEconomizerAndTPI>>
{
    [Fact]
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(2.7733154591838005, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(3.773315459183803, comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout16() =>
        fixture
            ...
            .BeApproximately(16.193152260389702, comparison.Tolerance);

    [Fact]
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout16() =>
        fixture
            .AnalysisResult.MinSpecificWorkRatio.Percent.Should()
            .BeApproximately(16.124874623066734, comparison.Tolerance);
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout13() =>
        fixture
            ...
            .BeApproximately(13.841278779116035, comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout30() =>
        fixture
            ...
            .BeApproximately(30.34923839135392, comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout13() =>
        fixture
            ...
            .BeApproximately(13.302779314766417, comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        fixture
            ...
            .BeApproximately(0.4234305005094076, comparison.Tolerance);
