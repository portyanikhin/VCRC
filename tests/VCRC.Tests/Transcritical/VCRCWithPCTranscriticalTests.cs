...
public sealed class VCRCWithPCTranscriticalTests(
    ...
    TranscriticalVCRCFixture<IVCRCWithPC> fixture
) : IClassFixture<ComparisonFixture>, IClassFixture<TranscriticalVCRCFixture<IVCRCWithPC>>
{
    [Fact]
        ...
        fixture
            .Instance.HeatReleaserSpecificMassFlow.Equals(
                fixture.Instance.EvaporatorSpecificMassFlow
                    * (
                        1
                        + fixture.Instance.Point7.Quality!.Value.DecimalFractions
                            / (1 - fixture.Instance.Point7.Quality!.Value.DecimalFractions)
                    ),
                comparison.Tolerance.Percent()
            )
            .Should()
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(2.964401783635744, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(3.964401783635742, comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout17() =>
        fixture
            ...
            .BeApproximately(17.308888999418738, comparison.Tolerance);

    [Fact]
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout17() =>
        fixture
            .AnalysisResult.MinSpecificWorkRatio.Percent.Should()
            .BeApproximately(17.219355169211614, comparison.Tolerance);
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout20() =>
        fixture
            ...
            .BeApproximately(20.19778139644419, comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout26() =>
        fixture
            ...
            .BeApproximately(26.299474729838668, comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout14() =>
        fixture
            ...
            .BeApproximately(14.200049265764939, comparison.Tolerance);
    ...
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout2() =>
        fixture
            ...
            .BeApproximately(2.0833394387406, comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        fixture
            ...
            .BeApproximately(0.5199604127290963, comparison.Tolerance);
