...
public sealed class VCRCWithEjectorEconomizerAndPCTranscriticalTests(
        ...
        IClassFixture<TranscriticalVCRCFixture<IVCRCWithEjectorEconomizerAndPC>>
{
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(3.5417485177872754, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(4.541686029531546, comparison.Tolerance);
    }
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout20() =>
        fixture
            ...
            .BeApproximately(20.973099770803934, comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        fixture
            ...
            .BeApproximately(0.0805812133279584, comparison.Tolerance);
