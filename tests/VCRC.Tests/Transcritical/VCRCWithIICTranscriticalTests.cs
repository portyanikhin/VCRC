...
public sealed class VCRCWithIICTranscriticalTests(
    ComparisonFixture comparison,
    TranscriticalVCRCFixture<IVCRCWithIIC> fixture
) : IClassFixture<ComparisonFixture>, IClassFixture<TranscriticalVCRCFixture<IVCRCWithIIC>>
{
    [Fact]
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(2.935653303601381, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(3.935653303601381, comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout17() =>
        fixture
            ...
            .BeApproximately(17.14102907821518, comparison.Tolerance);

    [Fact]
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout17() =>
        fixture
            .AnalysisResult.MinSpecificWorkRatio.Percent.Should()
            .BeApproximately(17.063415588517042, comparison.Tolerance);
    ...
    public void GasCoolerEnergyLossRatio_ForThisCase_ReturnsAbout21() =>
        fixture
            ...
            .BeApproximately(21.022190486946972, comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout26() =>
        fixture
            ...
            .BeApproximately(26.061305006201664, comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout14() =>
        fixture
            ...
            .BeApproximately(14.071452712259557, comparison.Tolerance);
    ...
    public void TestMixingEnergyLossRatio_ForThisCase_ReturnsAbout1() =>
        fixture
            ...
            .BeApproximately(1.7816362060747746, comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        fixture
            ...
            .BeApproximately(0.4548531874847325, comparison.Tolerance);
