        ...
        IClassFixture<SubcriticalVCRCFixture<IVCRCWithEjectorAndEconomizer>>
{
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(4.783695679338165, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(5.783610594561565, comparison.Tolerance);
    }
