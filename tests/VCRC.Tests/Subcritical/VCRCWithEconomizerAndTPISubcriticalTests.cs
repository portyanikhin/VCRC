...
public sealed class VCRCWithEconomizerAndTPISubcriticalTests(
        ...
        IClassFixture<SubcriticalVCRCFixture<IVCRCWithEconomizerAndTPI>>
{
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(4.631753388612427, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(5.6317533886124265, comparison.Tolerance);
    }
    ...
    public void ThermodynamicPerfection_ForThisCase_ReturnsAbout27() =>
        fixture
            ...
            .BeApproximately(27.044412710428052, comparison.Tolerance);

    [Fact]
    public void MinSpecificWorkRatio_ForThisCase_ReturnsAbout26() =>
        fixture
            .AnalysisResult.MinSpecificWorkRatio.Percent.Should()
            .BeApproximately(26.91101090768845, comparison.Tolerance);
    ...
    public void CondenserEnergyLossRatio_ForThisCase_ReturnsAbout18() =>
        fixture
            ...
            .BeApproximately(18.344803373964044, comparison.Tolerance);
    ...
    public void ExpansionValvesEnergyLossRatio_ForThisCase_ReturnsAbout7() =>
        fixture
            ...
            .BeApproximately(7.714502918858777, comparison.Tolerance);
    ...
    public void EvaporatorEnergyLossRatio_ForThisCase_ReturnsAbout22() =>
        fixture
            ...
            .BeApproximately(22.5407081419088, comparison.Tolerance);
    ...
    public void AnalysisRelativeError_Always_ReturnsNegligibleValue()
    {
        fixture
            ...
            .BeApproximately(0.4957145727345726, comparison.Tolerance);
