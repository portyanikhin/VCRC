        ...
        IClassFixture<SubcriticalVCRCFixture<IVCRCWithEjectorEconomizerAndTPI>>
{
    ...
    public void EER_Always_ReturnsRatioBetweenSpecificCoolingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.EER.Should().BeApproximately(4.877124735439032, comparison.Tolerance);
    }
    ...
    public void COP_Always_ReturnsRatioBetweenSpecificHeatingCapacityAndSpecificWork()
    {
        ...
        fixture.Instance.COP.Should().BeApproximately(5.877039217058631, comparison.Tolerance);
    }
