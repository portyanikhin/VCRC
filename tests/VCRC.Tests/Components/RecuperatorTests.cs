...
public sealed class RecuperatorTests : IClassFixture<ComparisonFixture>
{
    ...
    public static void Recuperator_WrongSuperheat_ThrowsValidationException(double superheat)
    {
        ...
        action
            ...
            .WithMessage(
                "*Temperature difference at the recuperator 'hot' side should be in (0;50) K!*"
            );
    }
    ...
    {
        _recuperator
            .TemperatureDifference.Equals(_temperatureDifference, _comparison.Tolerance.Kelvins())
            .Should()
            .BeTrue();
