...
```shell
PM> Install-Package SharpProp -Version 4.2.3
```

```shell
PM> Install-Package VCRC -Version 2.1.3
```
...
```xml
<ItemGroup>
    <PackageReference Include="SharpProp" Version="4.2.3"/>
    <PackageReference Include="VCRC" Version="2.1.3"/>
</ItemGroup>
```
