...
```shell
PM> Install-Package SharpProp -Version 4.2.2
```

```shell
PM> Install-Package VCRC -Version 2.1.2
```
...
```xml
<ItemGroup>
    <PackageReference Include="SharpProp" Version="4.2.2"/>
    <PackageReference Include="VCRC" Version="2.1.2"/>
</ItemGroup>
```
