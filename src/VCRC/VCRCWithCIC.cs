...
public class VCRCWithCIC : AbstractTwoStageVCRC, IVCRCWithCIC
{
    ...
    /// </exception>
    public VCRCWithCIC(IEvaporator evaporator, ICompressor compressor, IHeatReleaser heatReleaser)
    ...
    public sealed override Ratio IntermediateSpecificMassFlow => HeatReleaserSpecificMassFlow;
